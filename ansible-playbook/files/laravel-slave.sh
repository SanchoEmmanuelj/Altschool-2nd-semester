...
# WE START BY UPDATING & UPGRADING THE SERVER WITH THE FOLLOWING 
...
# CODE FOR THE INSTALLATION OF LAMP STACK AND ANSIBLE 
...
# THE CODE BELOW WILL INSTALL COMPOSER
...
# THE CONFIGURATION OF APACHE2

cat << EOF > /etc/apache2/sites-available/laravel.conf
<VirtualHost *:80>
    ServerAdmin sanchoemmanuelj@gmail.com
    ServerName 206.189.63.193
...
# CLONE LARAVEL APPLICATION AND ALL ITS DEPENDENCIES
...
sudo sed -i 's/DB_DATABASE=laravel/DB_DATABASE=sancho/' /var/www/html/laravel/.env

sudo sed -i 's/DB_USERNAME=root/DB_USERNAME=sancho/' /var/www/html/laravel/.env

sudo sed -i 's/DB_PASSWORD=/DB_PASSWORD=sancho90/' /var/www/html/laravel/.env
